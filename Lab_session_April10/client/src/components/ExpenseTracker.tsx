    ...
    return (
        <Container className="my-4">
            ...
            <Table striped bordered hover size="sm">
                        ...
                        items.map((item) => (
                            <tr key={item.id}>
                                ...
                                <td className={
                                    item.payeeName === "Rahul"
                                        ? "bg-warning text-dark"
                                        : "bg-danger text-light"}>{item.setDate}</td>

                                <td className={
                                    item.payeeName === "Rahul"
                                        ? "bg-warning text-dark"
                                        : "bg-danger text-light"}>{item.product}</td>
                                <td  className={
                                    item.payeeName === "Rahul"
                                        ? "bg-warning text-dark text-end font-monospace"
                                        : "bg-danger text-light text-end font-monospace"}>
                                    {item.price}
                                </td>
                            </tr>
                        ))
                ...
                <tfoot>
                <tr className = "bg-primary fw-bolder">
                    ...
                    <tr className = "bg-warning fw-bolder">
                        <td colSpan={3} className="text-end">
                    ...
                    <tr  className = "bg-danger fw-bolder">
                        <td colSpan={3} className="text-end">
